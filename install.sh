...
cd ~
wget https://github.com/archroot/theme_installer_for_xfcex4/raw/master/files/.config.tar.gz
tar -xzf .config.tar.gz -C ~

echo 'Ставим лого ArchLinux в меню'
wget https://github.com/archroot/theme_installer_for_xfce4/raw/master/files/archlinux_logo.png
sudo mv -f ~/archlinux_logo.png /usr/share/pixmaps/archlinux_logo.png

echo 'Ставим обои на рабочий стол'
wget https://github.com/archroot/theme_installer_for_xfce4/raw/master/files/Deepin_Linux_Manjaro.jpg
